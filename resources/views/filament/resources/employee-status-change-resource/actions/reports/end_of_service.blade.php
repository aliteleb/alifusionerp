...
<body>
    <div class="document">
        ...
        <div class="document-title">
            {{ __('End of Service') }}
            <span class="status-badge status-end-of-service">
                {{ __('End of Service') }}
            </span>
        </div>
        ...
        <div class="content">
            ...
            <div class="letter-content">
                ...
                <div class="letter-body">
                    {{ __('This letter serves to confirm the end of your service with the company, effective from :date. We request you to visit the finance department to settle your final dues.', ['date' => $record->change_date->format('d/m/Y')]) }}
                </div>
                ...
                <div class="closing-message">
                    {{ __('We thank you for your contributions and wish you success in your future endeavors.') }}
                </div>
