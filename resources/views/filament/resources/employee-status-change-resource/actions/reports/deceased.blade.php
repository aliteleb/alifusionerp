...
<head>
    ...
    <title>
        {{ __('Deceased Employee Notification') }}
    </title>
    ...
    <div class="document">
        ...
        <div class="content">
            ...
            <div class="letter-content">
                ...
                <div class="salutation">{{ __('To Whom It May Concern') }}</div>
                
                <div class="letter-body">
                    {{ __('It is with deep regret that we inform you of the passing of our employee, :employee_name, on :date. Please contact the HR department for information regarding the final settlement of dues.', ['employee_name' => $record->employee->full_name, 'date' => $record->change_date->format('d/m/Y')]) }}
                </div>
                ...
                <div class="closing-message">
                    {{ __('Our sincere condolences to the family and friends of the deceased.') }}
                </div>
