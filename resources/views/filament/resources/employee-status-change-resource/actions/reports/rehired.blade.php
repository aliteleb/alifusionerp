...
<body>
    <div class="document">
        ...
        <div class="document-title">
            {{ __('Employee Rehired') }}
            <span class="status-badge status-rehired">
                {{ __('Rehired') }}
            </span>
        </div>
        ...
        <div class="content">
            ...
            <div class="letter-content">
                ...
                <div class="letter-body">
                    {{ __('We are pleased to inform you that you have been rehired by the company, effective from :date. Please review the HR department to complete the necessary procedures.', ['date' => $record->change_date->format('d/m/Y')]) }}
                </div>
