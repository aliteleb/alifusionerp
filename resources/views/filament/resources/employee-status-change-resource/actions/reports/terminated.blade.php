...
<body>
    <div class="document">
        ...
        <div class="document-title">
            {{ __('Employee Termination') }}
            <span class="status-badge status-termination">
                {{ __('Termination') }}
            </span>
        </div>
        ...
        <div class="content">
            ...
            <div class="letter-content">
                ...
                <div class="letter-body">
                    {{ __('The company administration would like to inform you of the decision to dispense with your services as of :date, so please review the accounts department to pay your dues.', ['date' => $record->change_date->format('d/m/Y')]) }}
                </div>
                ...
                <div class="closing-message">
                    {{ __('Thank you for your service to the company') }}
                </div>
