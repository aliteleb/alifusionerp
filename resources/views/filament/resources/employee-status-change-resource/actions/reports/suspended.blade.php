        ...
        <div class="content">
            ...
            <div class="letter-content">
                ...
                <div class="letter-body">
                    {{ __('This letter is to inform you that you have been suspended from your duties, effective from :date. This action is taken pending further investigation. You will be contacted with more information in due course.', ['date' => $record->change_date->format('d/m/Y')]) }}
                </div>
                ...
                <div class="closing-message">
                    {{ __('Please await further instructions from the HR department.') }}
                </div>
