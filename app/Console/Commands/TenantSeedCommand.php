...
use Modules\System\Actions\Facility\Seeding\SeedDesignationDataAction;
...
use Modules\System\Actions\Facility\Seeding\SeedWarehouseDataAction;
...
class TenantSeedCommand extends Command
{
    ...
    protected $signature = 'tenant:seed 
                            ...
                            {--class= : Specific seeder class to run (reference, branches, clients, customers, customer-groups, departments, designations, project-categories, projects, roles, settings, tickets, users, warehouses)}
    ...
    private array $availableSeeders = [
        ...
        'designations' => SeedDesignationDataAction::class,
        ...
        'warehouses' => SeedWarehouseDataAction::class,
    ];
