...
return [
    ...
    'clusters' => [
        ...
        'use-top-navigation' => false, // display the main cluster menu in the sidebar (vertical) instead of top navigation (horizontal)
    ],
    'panels' => [
        'group' => 'Modules', // the group name for the panels in the navigation
