...
export default {
    ...
    content: [
        ...
        // Add the copyright footer component path explicitly
        "./resources/views/filament/components/copyright-footer.blade.php",
        // Also include all filament components
        "./resources/views/filament/components/*.blade.php",
    ],
    theme: {
        extend: {
            colors: {
